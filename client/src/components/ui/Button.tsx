...
const VARIANTS: Record<Variant, string> = {
  primary:
    "bg-primary-container text-on-primary-container font-semibold hover:-translate-y-px hover:bg-primary-fixed-dim shadow-[0_10px_24px_-12px_rgb(247_167_24_/_0.8)]",
  secondary:
